...
class bi_edge(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    edge_a_to_b = property(_topylogic.bi_edge_edge_a_to_b_get, _topylogic.bi_edge_edge_a_to_b_set)
    edge_b_to_a = property(_topylogic.bi_edge_edge_b_to_a_get, _topylogic.bi_edge_edge_b_to_a_set)
