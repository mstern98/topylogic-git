...
void vertex_f(struct graph* graph, struct vertex_result* args, void* glbl, void* edge_vars){
	...
	void* res = (PyCFunction)(void(*)(struct graph*, struct vertex_result*, void*, void*)(pyCallback(graph, args, glbl2, edge_vars)));
	assert(res!=NULL);
}
...
void generic_f(void* glbl){
	...
	void* res = (PyCFunction)(void(*)(void*)(pyCallback(glbl2)));
